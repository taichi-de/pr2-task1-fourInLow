...
public class FourInRow {
    public static void main(String[] args) {
        ...
        System.out.println(player1.getName()+", " +
                "you're the Player 1 (X). Now, lets enter the name of the second Player..");
        ...
        System.out.println("The first turn is: "+((game.currentTurn == 1) ? player1.getName()+" [X]" :
                player2.getName()+" [O]")+". Enter the Column to insert (from 1 to 7): ");
        int userInput;
        while(sc.hasNext()) {
            ...
            if(game.checkGame(game.currentTurn) != 0) {
                System.out.print("Wow, we have the Winner! It's the Player " +((game.winPlayer == 1) ?
